...
def unet_train():
    ...
    for i in tqdm(range(n)):
        ...
        label = get_label(input_name[i],0)
...
def load_and_train(model_path, X_train,Y_train, epochs=1, batch_size=8):
    # Load saved model
...
img_src,img_mask=unet_predict(model, 'resources/images/medium/2-2.jpg')
