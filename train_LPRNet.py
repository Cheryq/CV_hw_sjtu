...
def get_parser():
    ...
    parser.add_argument('--max_epoch', default=3, help='epoch to train the network')
    parser.add_argument('--img_size', default=[94, 24], help='the image size')
    parser.add_argument('--train_img_dirs', default="trainMixLPR", help='the train images path')
    parser.add_argument('--test_img_dirs', default="testMixLPR", help='the test images path')
    parser.add_argument('--dropout_rate', default=0.5, help='dropout rate.')
    parser.add_argument('--learning_rate', default=0.2, help='base value of learning rate.')
    parser.add_argument('--lpr_max_len', default=8, help='license plate number max length.')
    parser.add_argument('--train_batch_size', default=7, help='training batch size.')
    parser.add_argument('--test_batch_size', default=7, help='testing batch size.')
    ...
    parser.add_argument('--pretrained_model', default='./model/Final_LPRNet_model.pth', help='pretrained base model')
